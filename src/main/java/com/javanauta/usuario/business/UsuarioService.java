...
public class UsuarioService {
    ...
    public UsuarioDTO buscarUsuarioPorEmail(String email) {
        try {
            ...
            throw new ResourceNotFoundExeception("Email não encontrado" + email);
        }
...
public EnderecoDTO atualizaEndereco (Long idEndereco, EnderecoDTO enderecoDTO){
    Endereco entity = enderecoRepository.findById(idEndereco).orElseThrow(() ->
            new ResourceNotFoundExeception("Id não encontrado" + idEndereco));
...
public TelefoneDTO atualizaTelefone (Long idTelefone, TelefoneDTO telefoneDTO){
    ...
    Telefone entity = telefoneRepository.findById(idTelefone).orElseThrow(() ->
            new ResourceNotFoundExeception("Id não encontrado" + idTelefone));
...
public EnderecoDTO cadastraEndereco (String token, EnderecoDTO dto) {
    ...
    Usuario usuario = usuarioRepository.findByEmail(email).orElseThrow(
            () -> new ResourceNotFoundExeception("Email não localizado" + email));
